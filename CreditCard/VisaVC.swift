...
class VisaVC: UIViewController,STPPaymentCardTextFieldDelegate {
    @IBOutlet weak var creditCardView: CreditCardFormView!
    let paymentTextField = STPPaymentCardTextField()
     var cardHolderNameTextField: TextField!
    ...
    func createTextField() {
        ...
        cardHolderNameTextField.addTarget(self, action: #selector(VisaVC.textFieldDidChange(_:)), for: .editingChanged)
